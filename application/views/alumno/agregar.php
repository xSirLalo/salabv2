<?php echo form_open(base_url().'alumno/guardar', 'class="form-horizontal" role="form" id="form"'); ?>

  <div class="form-group">
    <label for="noControl" class="col-lg-2 control-label">Numero de control</label>
    <div class="col-lg-10">
      <input type="text" class="form-control" id="noControl" name="noControl" value="<?php echo set_value('noControl'); ?>"
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" class="form-control" id="nombre_al" name="nombre_al" value="<?php echo set_value('nombre_al'); ?>"
             placeholder="Nombre">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" class="form-control" id="aPaterno_al" name="aPaterno_al" value="<?php echo set_value('aPaterno_al'); ?>"
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" class="form-control" id="aMaterno_al" name="aMaterno_al" value="<?php echo set_value('aMaterno_al'); ?>"
             placeholder="Apellido Paterno">
